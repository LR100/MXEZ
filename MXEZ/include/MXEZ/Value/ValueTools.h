#ifndef VALUETOOLS_H_
#define VALUETOOLS_H_
...
#define MXEZ_RADIANS(deg)  ((deg) * PI / 180.0f)
#define MXEZ_DEGREES(rad)  ((rad) * 180.0f / PI)

#define MXEZ_FLOAT_INF 3402823000000000000000.0f
#define MXEZ_PI 3.14159265359
#define MXEZ_D_TO_R(n) (n * (MMC_PI / 180.0f))

#define MXEZ_LOW_VALUE 0.0000000001f
#define MXEZ_SQRT_MAGIC_F 0x5f3759df 
	...
	inline float ValueTools::FastSqrt(const float& value)
	{
		...
		u.x = value;
		u.i = MXEZ_SQRT_MAGIC_F - (u.i >> 1);  // gives initial guess y0
